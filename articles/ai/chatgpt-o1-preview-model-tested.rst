...
.. note:: **TL;DR**
   - Rigorous testing of the **ChatGPT o1-preview model** against **gpt-4o** on mathematical reasoning tasks — **Diophantine equations, continued fractions, and exponential calculations** — revealing significant precision regressions (up to 0.14% error) in numerical computation despite improved complex problem-solving.
   - Written by Patrizio Gelosi at Amarula Solutions, comparing model behavior through systematic, reproducible benchmarks.

.. figure:: /images/chatgpt-o1-preview-model-tested_intro.png
...
.. tip::
   Interested in AI model evaluation or integrating LLMs into your
   development workflow? Amarula Solutions builds and evaluates AI-powered
   tools for code review and embedded development.
   `Contact us about AI integration <https://www.amarulasolutions.com/contact/>`_

...
.. note:: **TL;DR**
   - Amarula Solutions mainlined the **Engicam i.Core MX8M Mini SoM** (NXP i.MX8MM) along with **EDIMM 2.2 and CTouch 2.0 carrier boards** — running **Linux 5.13, U-Boot v2021-04**, with TPL/SPL bootflow and Ubuntu 20.04 support.
...
.. tip::
   Need mainline BSP support for your NXP i.MX-based product? Amarula Solutions
   provides U-Boot and Linux kernel mainlining, Yocto/Buildroot integration,
   and long-term maintenance for i.MX6, i.MX8M, and i.MX8M Plus platforms.

...
.. note:: **TL;DR**
   - Amarula Solutions demonstrates **USB Type-C Power Delivery with Altmode DisplayPort** on **Rockchip RK3399 (ROC-RK3399-PC)** running **Linux 5.10** — using the FUSB302 Type-C controller with the Linux extcon framework.
...
.. tip::
   Need USB Type-C PD or DisplayPort Altmode support on your embedded
   product? Amarula Solutions provides Linux kernel driver development for
   USB-C, DisplayPort, and power delivery on Rockchip and other ARM platforms.

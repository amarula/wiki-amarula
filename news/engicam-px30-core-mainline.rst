...
.. note:: **TL;DR**
   - Amarula Solutions mainlined the **Engicam PX30.Core SoM** (Rockchip PX30) along with **EDIMM 2.2 and CTouch 2.0 carrier boards** — running **Linux 5.10 and U-Boot v2020-10** with TPL/SPL bootflow and Ubuntu 20.04.
...
.. tip::
   Need mainline BSP support for Rockchip PX30-based products? Amarula Solutions
   provides U-Boot and Linux kernel mainlining, Yocto/Buildroot integration,
   and long-term maintenance for Rockchip platforms.

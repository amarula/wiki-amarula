...
.. note:: **TL;DR**
   - Amarula Solutions mainlined **ROCK Pi 4A/B/C** (Rockchip RK3399) in partnership with Radxa — running **Linux 5.10 and U-Boot v2020-10** with TPL/SPL bootflow, HDMI, DisplayPort, WiFi/BT, PCIe M.2, and Ubuntu 20.04.
...
.. tip::
   Need mainline BSP support for Rockchip RK3399-based products? Amarula Solutions
   provides U-Boot and Linux kernel mainlining, Yocto/Buildroot integration,
   and multimedia enablement for Rockchip platforms.

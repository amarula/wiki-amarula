...
.. note:: **TL;DR**
   - How to enable **IntelliJ IDEA auto-completion for Jenkins pipeline scripts** using **GDSL (GroovyDSL)** — generating type-aware syntax highlighting and code completion from your Jenkins instance, including shared library classes and custom global variables.
   - Covers GDSL generation from Jenkins UI, manual script creation, shared library integration patterns, and troubleshooting.
...
What are the advantages of GDSL files?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
How do you get GDSL from the pipeline into IntelliJ IDEA?
=========================================================
...
How do you troubleshoot GDSL issues?
------------------------------------
...
How do you get auto-completion for shared libraries?
====================================================
...
What resources are available for learning GDSL?
-----------------------------------------------
...
.. tip::
   Want autocompletion for your Jenkins pipelines and shared libraries?
   Amarula Solutions provides Jenkins development environment setup,
   shared library architecture, and IDE integration for CI/CD teams.

...
.. note:: **TL;DR**
   - How to set up **Jenkins pipeline autocompletion in IntelliJ IDEA** — using the **Jenkins GDSL file** generated from your Jenkins instance to enable syntax highlighting and code completion for pipeline scripts and shared libraries.
   - Covers GDSL generation, IDE project setup, and shared library JAR import for full autocompletion support.
...
How do you set up IntelliJ for autocompletion?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. tip::
   Need IDE integration for your Jenkins pipeline development? Amarula
   Solutions provides GDSL configuration, shared library JAR distribution,
   and developer tooling setup for CI/CD teams.
